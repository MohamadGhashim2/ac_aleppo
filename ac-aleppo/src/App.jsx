...
export default function App() {
  ...
  const homeSeoKeywords = [
    "أبو حلب تكييف سيارات",
    "ابوحلب تكييف سيارات",
    "أبو حلب كهربائي سيارات",
    "ابوحلب كهربائي سيارات",
    "كهربائي سيارات الرياض",
    "كهربائي سيارات صناعية النسيم",
    "تكييف سيارات الرياض",
    "تكييف سيارات صناعية النسيم",
    "ورشة تكييف سيارات الرياض",
    "ورشة مكيفات سيارات الرياض",
    "تصليح مكيف سيارات الرياض",
    "إصلاح مكيف سيارات الرياض",
    "تعبئة فريون سيارات الرياض",
    "كشف تهريب فريون الرياض",
    "كمبروسر مكيف سيارة الرياض",
    "فحص كهرباء مكيف السيارة",
    "صيانة مكيف السيارة الرياض",
    "أفضل ورشة مكيفات سيارات بالرياض",
  ];
    ...
    <>
      ...
      <footer id="contact" className="footer">
        ...
        <div className="container">
          ...
          <p className="footer-seo-text">
            يبحث عنا العملاء في الرياض بعبارات مثل أبو حلب تكييف سيارات،
            ابوحلب تكييف سيارات، أبو حلب كهربائي سيارات، كهربائي سيارات
            الرياض، كهربائي سيارات صناعية النسيم، وورشة مكيفات سيارات في
            صناعية النسيم. نركز على أعطال مكيف السيارة والكهرباء المرتبطة
            بالتبريد والفريون والكمبروسر.
          </p>
        </div>
